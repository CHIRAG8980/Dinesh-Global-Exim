        ...
        <div className="glass-panel p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-2">
              Join Dinesh Global Exim and start your trading journey
            </p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white shiny-gold-bg   focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-all shadow-amber-500/25 mt-4"
            >
              Register Now
              <ArrowRight size={18} />
            </button>
